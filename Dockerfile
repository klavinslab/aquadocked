...
#RUN /bin/bash -l -c "cd /root/aquarium; gem install json -v '1.8.6'"
RUN /bin/bash -l -c "cd /root/aquarium; gem install nokogiri -v '1.7.2'"
#RUN /bin/bash -l -c "cd /root/aquarium; gem install bcrypt-ruby -v '3.0.1'"
#RUN /bin/bash -l -c "cd /root/aquarium; gem install debug_inspector -v '0.0.3'" 
#RUN /bin/bash -l -c "cd /root/aquarium; gem install binding_of_caller -v '0.7.3'" 
